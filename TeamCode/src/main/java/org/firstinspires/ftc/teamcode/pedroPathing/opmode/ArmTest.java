...
public class ArmTest extends OpMode {
    ...
    public double x = 0;
    public double y = 0;
    public double wristdegrees = 0;
    public double flipdegrees = 0;
    public double flipzero = 0;
    public double wristzero = 0;
    public DcMotor front_left = null;
    public DcMotor front_right = null;
    public double hangpose = 0;
    @Override
    public void init() {
    ...
    public void arm(){
        ...
        x = ((slidesPose / 2 / slideticks + 15) * Math.cos(armPose / armticks)) + (6 * Math.cos((wrist_at - wristzero) * wristdegrees)) + (7 * Math.cos((flip.getPosition() - flipzero) * flipdegrees));
        y = ((slidesPose / 2 / slideticks + 15) * Math.sin(armPose / armticks)) + (6 * Math.sin((wrist_at - wristzero) * wristdegrees)) + (7 * Math.sin((flip.getPosition() - flipzero) * flipdegrees));
        ...
        telemetry.addData("Specimen X: ", x);
        telemetry.addData("Specimen Y: ", y);
        telemetry.update();
