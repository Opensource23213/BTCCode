...
public class FConstants {
    static {
        ...
        FollowerConstants.translationalPIDFCoefficients.setCoefficients(0.8,0.0001,0.03,0);
        ...
        FollowerConstants.secondaryDrivePIDFCoefficients.setCoefficients(0.001,0,0,0.6,0); // Not being used, @see useSecondaryDrivePID
