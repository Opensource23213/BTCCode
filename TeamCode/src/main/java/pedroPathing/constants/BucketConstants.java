...
public class BucketConstants {
    static {
        ...
        FollowerConstants.drivePIDFCoefficients.setCoefficients(0.01,0,.002,0.6,0);
        FollowerConstants.useSecondaryDrivePID = true;
        FollowerConstants.drivePIDFSwitch = 50;
        FollowerConstants.secondaryDrivePIDFCoefficients.setCoefficients(0.003,0,0,0.6,0); // Not being used, @see useSecondaryDrivePID
